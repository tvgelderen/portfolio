    ...
    return (
        <AnimatePresence initial={false}>
            <div className='relative max-w-[900px] flex items-center m-auto'>
                ...
                {images.length > 1 && (
                    <>
                    <div className='z-[10] absolute left-1 p-1 rounded-full bg-black/30 cursor-pointer' onClick={handlePrevious}>
                        <BsChevronCompactLeft className='w-7 h-7 sm:w-9 sm:h-9 lg:w-12 lg:h-12' />
                    </div>
                    <div className='z-[10] absolute right-1 p-1 rounded-full bg-black/30 cursor-pointer' onClick={handleNext}>
